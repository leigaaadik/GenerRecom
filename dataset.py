...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, uid):
        ...
        if not ext_user_sequence:
            # Fill feature arrays with default value if sequence is empty
        ...
        for record_tuple in reversed(ext_user_sequence[:-1]):
            ...
            seq_ts[idx] = timestamp if timestamp is not None else 0
        ...
        # Correctly fill default values for any remaining empty slots
    ...
    def _init_feat_info(self):
        ...
        feat_types['item_sparse'] = [
            '100', '117', '111', '118', '101', '102', '119', '120', '114',
            '112', '121', '115', '122', '116',
        ]
    ...
    def fill_missing_feat(self, feat, item_id):
        ...
        for feat_id in self.feature_types['item_emb']:
            if item_id != 0 and self.indexer_i_rev.get(item_id) in self.mm_emb_dict[feat_id]:
    ...
    def collate_fn(batch):
        ...
        seq_ts = torch.from_numpy(np.array(seq_ts))
...
class MyTestDataset(MyDataset):
    ...
    def __getitem__(self, uid):
        ...
        # Correctly fill default values for unfilled (padded) feature slots
        for i in range(idx + 1):
            seq_feat[i] = self.feature_default_value
